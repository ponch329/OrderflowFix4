...
4. **Create OAuth Credentials**
   ...
   - Authorized redirect URIs:
     ```
     https://reviewflow-4.preview.emergentagent.com/api/oauth/sheets/callback
     ```
   - Click "Create"
...
6. **Authorize the App**
   ...
   - Visit: `https://reviewflow-4.preview.emergentagent.com/api/oauth/sheets/login`
...
- `SPREADSHEET_ID`
- `SHEETS_REDIRECT_URI` = `https://reviewflow-4.preview.emergentagent.com/api/oauth/sheets/callback`
...
1. **Access Admin Dashboard**
   - Go to https://reviewflow-4.preview.emergentagent.com
...
**System URL**: https://reviewflow-4.preview.emergentagent.com
**Admin Dashboard**: https://reviewflow-4.preview.emergentagent.com/admin
**Customer Portal**: https://reviewflow-4.preview.emergentagent.com/customer
