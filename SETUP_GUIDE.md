...
4. **Create OAuth Credentials**
   ...
   - Authorized redirect URIs:
     ```
     https://order-track-pro-1.preview.emergentagent.com/api/oauth/sheets/callback
     ```
   - Click "Create"
...
6. **Authorize the App**
   ...
   - Visit: `https://order-track-pro-1.preview.emergentagent.com/api/oauth/sheets/login`
...
- `SPREADSHEET_ID`
- `SHEETS_REDIRECT_URI` = `https://order-track-pro-1.preview.emergentagent.com/api/oauth/sheets/callback`
...
1. **Access Admin Dashboard**
   - Go to https://order-track-pro-1.preview.emergentagent.com
...
**System URL**: https://order-track-pro-1.preview.emergentagent.com
**Admin Dashboard**: https://order-track-pro-1.preview.emergentagent.com/admin
**Customer Portal**: https://order-track-pro-1.preview.emergentagent.com/customer
