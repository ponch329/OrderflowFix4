...
4. **Create OAuth Credentials**
   ...
   - Authorized redirect URIs:
     ```
     https://workdesk-14.preview.emergentagent.com/api/oauth/sheets/callback
     ```
   - Click "Create"
...
6. **Authorize the App**
   ...
   - Visit: `https://workdesk-14.preview.emergentagent.com/api/oauth/sheets/login`
...
- `SPREADSHEET_ID`
- `SHEETS_REDIRECT_URI` = `https://workdesk-14.preview.emergentagent.com/api/oauth/sheets/callback`
...
1. **Access Admin Dashboard**
   - Go to https://workdesk-14.preview.emergentagent.com
...
**System URL**: https://workdesk-14.preview.emergentagent.com
**Admin Dashboard**: https://workdesk-14.preview.emergentagent.com/admin
**Customer Portal**: https://workdesk-14.preview.emergentagent.com/customer
