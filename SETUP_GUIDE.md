...
4. **Create OAuth Credentials**
   ...
   - Authorized redirect URIs:
     ```
     https://approvehub.preview.emergentagent.com/api/oauth/sheets/callback
     ```
   - Click "Create"
...
6. **Authorize the App**
   ...
   - Visit: `https://approvehub.preview.emergentagent.com/api/oauth/sheets/login`
...
- `SPREADSHEET_ID`
- `SHEETS_REDIRECT_URI` = `https://approvehub.preview.emergentagent.com/api/oauth/sheets/callback`
...
1. **Access Admin Dashboard**
   - Go to https://approvehub.preview.emergentagent.com
...
**System URL**: https://approvehub.preview.emergentagent.com
**Admin Dashboard**: https://approvehub.preview.emergentagent.com/admin
**Customer Portal**: https://approvehub.preview.emergentagent.com/customer
