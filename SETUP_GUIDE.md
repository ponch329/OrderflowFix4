...
4. **Create OAuth Credentials**
   ...
   - Authorized redirect URIs:
     ```
     https://headproof.preview.emergentagent.com/api/oauth/sheets/callback
     ```
   - Click "Create"
...
6. **Authorize the App**
   ...
   - Visit: `https://headproof.preview.emergentagent.com/api/oauth/sheets/login`
...
- `SPREADSHEET_ID`
- `SHEETS_REDIRECT_URI` = `https://headproof.preview.emergentagent.com/api/oauth/sheets/callback`
...
1. **Access Admin Dashboard**
   - Go to https://headproof.preview.emergentagent.com
...
**System URL**: https://headproof.preview.emergentagent.com
**Admin Dashboard**: https://headproof.preview.emergentagent.com/admin
**Customer Portal**: https://headproof.preview.emergentagent.com/customer
