...
4. **Create OAuth Credentials**
   ...
   - Authorized redirect URIs:
     ```
     https://trackingsync.preview.emergentagent.com/api/oauth/sheets/callback
     ```
   - Click "Create"
...
6. **Authorize the App**
   ...
   - Visit: `https://trackingsync.preview.emergentagent.com/api/oauth/sheets/login`
...
- `SPREADSHEET_ID`
- `SHEETS_REDIRECT_URI` = `https://trackingsync.preview.emergentagent.com/api/oauth/sheets/callback`
...
1. **Access Admin Dashboard**
   - Go to https://trackingsync.preview.emergentagent.com
...
**System URL**: https://trackingsync.preview.emergentagent.com
**Admin Dashboard**: https://trackingsync.preview.emergentagent.com/admin
**Customer Portal**: https://trackingsync.preview.emergentagent.com/customer
