...
4. **Create OAuth Credentials**
   ...
   - Authorized redirect URIs:
     ```
     https://approval-hub-16.preview.emergentagent.com/api/oauth/sheets/callback
     ```
   - Click "Create"
...
6. **Authorize the App**
   ...
   - Visit: `https://approval-hub-16.preview.emergentagent.com/api/oauth/sheets/login`
...
- `SPREADSHEET_ID`
- `SHEETS_REDIRECT_URI` = `https://approval-hub-16.preview.emergentagent.com/api/oauth/sheets/callback`
...
1. **Access Admin Dashboard**
   - Go to https://approval-hub-16.preview.emergentagent.com
...
**System URL**: https://approval-hub-16.preview.emergentagent.com
**Admin Dashboard**: https://approval-hub-16.preview.emergentagent.com/admin
**Customer Portal**: https://approval-hub-16.preview.emergentagent.com/customer
