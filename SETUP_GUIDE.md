...
4. **Create OAuth Credentials**
   ...
   - Authorized redirect URIs:
     ```
     https://proof-sync-saas.preview.emergentagent.com/api/oauth/sheets/callback
     ```
   - Click "Create"
...
6. **Authorize the App**
   ...
   - Visit: `https://proof-sync-saas.preview.emergentagent.com/api/oauth/sheets/login`
...
- `SPREADSHEET_ID`
- `SHEETS_REDIRECT_URI` = `https://proof-sync-saas.preview.emergentagent.com/api/oauth/sheets/callback`
...
1. **Access Admin Dashboard**
   - Go to https://proof-sync-saas.preview.emergentagent.com
...
**System URL**: https://proof-sync-saas.preview.emergentagent.com
**Admin Dashboard**: https://proof-sync-saas.preview.emergentagent.com/admin
**Customer Portal**: https://proof-sync-saas.preview.emergentagent.com/customer
