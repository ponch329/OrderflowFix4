...
4. **Create OAuth Credentials**
   ...
   - Authorized redirect URIs:
     ```
     https://proof-sphere.preview.emergentagent.com/api/oauth/sheets/callback
     ```
   - Click "Create"
...
6. **Authorize the App**
   ...
   - Visit: `https://proof-sphere.preview.emergentagent.com/api/oauth/sheets/login`
...
- `SPREADSHEET_ID`
- `SHEETS_REDIRECT_URI` = `https://proof-sphere.preview.emergentagent.com/api/oauth/sheets/callback`
...
1. **Access Admin Dashboard**
   - Go to https://proof-sphere.preview.emergentagent.com
...
**System URL**: https://proof-sphere.preview.emergentagent.com
**Admin Dashboard**: https://proof-sphere.preview.emergentagent.com/admin
**Customer Portal**: https://proof-sphere.preview.emergentagent.com/customer
