...
4. **Create OAuth Credentials**
   ...
   - Authorized redirect URIs:
     ```
     https://proofshop.preview.emergentagent.com/api/oauth/sheets/callback
     ```
   - Click "Create"
...
6. **Authorize the App**
   ...
   - Visit: `https://proofshop.preview.emergentagent.com/api/oauth/sheets/login`
...
- `SPREADSHEET_ID`
- `SHEETS_REDIRECT_URI` = `https://proofshop.preview.emergentagent.com/api/oauth/sheets/callback`
...
1. **Access Admin Dashboard**
   - Go to https://proofshop.preview.emergentagent.com
...
**System URL**: https://proofshop.preview.emergentagent.com
**Admin Dashboard**: https://proofshop.preview.emergentagent.com/admin
**Customer Portal**: https://proofshop.preview.emergentagent.com/customer
