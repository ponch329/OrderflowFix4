...
4. **Create OAuth Credentials**
   ...
   - Authorized redirect URIs:
     ```
     https://orderflow-fix-4.preview.emergentagent.com/api/oauth/sheets/callback
     ```
   - Click "Create"
...
6. **Authorize the App**
   ...
   - Visit: `https://orderflow-fix-4.preview.emergentagent.com/api/oauth/sheets/login`
...
- `SPREADSHEET_ID`
- `SHEETS_REDIRECT_URI` = `https://orderflow-fix-4.preview.emergentagent.com/api/oauth/sheets/callback`
...
1. **Access Admin Dashboard**
   - Go to https://orderflow-fix-4.preview.emergentagent.com
...
**System URL**: https://orderflow-fix-4.preview.emergentagent.com
**Admin Dashboard**: https://orderflow-fix-4.preview.emergentagent.com/admin
**Customer Portal**: https://orderflow-fix-4.preview.emergentagent.com/customer
