...
def get_customer_proofs_ready_email(order_number, customer_name, stage, num_images, portal_url="https://shopify-proof.preview.emergentagent.com/customer", logo_url=None, company_name=""):
    """
