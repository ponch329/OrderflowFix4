...
def get_customer_proofs_ready_email(order_number, customer_name, stage, num_images, portal_url="https://proof-sync-saas.preview.emergentagent.com/customer", logo_url=None, company_name=""):
    """
